...
const AddPage = () => {
 ...
 const upload = async () => {
  ...
  console.log("Uploading to:", cloudName); // 🔍 Debug
  console.log("Using preset:", uploadPreset); // 🔍 Debug
  ...
  if (!res.ok) {
    console.error("Cloudinary error response:", resData); // 🔍 See the actual error
